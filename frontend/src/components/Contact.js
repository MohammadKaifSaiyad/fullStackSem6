...
const Contact = () => {
  ...
  return (
    <div>
        <Header/>
        <div className='text-3xl font-medium mt-10 text-center text-customeColor-400'>Contact Us</div>
            <div className='flex flex-row mt-20 mx-10 justify-items-center items-center'>
                <div className='w-3/6'>
                    <form action="#" className="space-y-8 w-5/6">
                        <div>
