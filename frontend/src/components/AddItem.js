    ...
    <div className="bg-zinc-700 h-full">
      ...
      <form class="mx-12 my-12" onSubmit={handleAddItem} encType='multipart/form-data'>
        ...
        <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white" for="file_input">Upload file</label>
          <input class="block w-80 text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400" id="img_file" onChange={handleFileChange} name="img_file" ref={imgRef} type="file"/>
